...
Tugas ini berisi implementasi jaringan server menggunakan Docker. 
Di dalam proyek ini ada 4 layanan utama yang saling terhubung 
dalam satu network 'asj-net'.
...
AKSES LAYANAN (IP DEBIAN):
--------------------------
* Web Interface  : http://192.168.1.30:3000
* API Users      : http://192.168.1.30:8080/users
* MinIO Console  : http://192.168.1.30:9001 
  (User: icall, Pass: icall.2006)
